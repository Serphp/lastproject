...
class GameScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.generateWave();
    gameState.customers.add(customerCointainer);
  }
  ...
  generateWave() {
    ...
    totalCustomerCount: Math.ceil(Math.random() * 10);
    gameState.currentWaveCount * gameState.totalCustomerCount; //no sé si esto está bien
